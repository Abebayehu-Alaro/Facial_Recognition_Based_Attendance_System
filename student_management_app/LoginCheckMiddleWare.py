...
class LoginCheckMiddleWare(MiddlewareMixin):
    ...
    def process_view(self, request, view_func, view_args, view_kwargs):
        ...
        if user.is_authenticated:
            if user.user_type == "1":
                if modulename == "student_management_app.ICT_ProfessionalViews":
                    pass
                ...
                if modulename == "student_management_app.InstructorViews":
                    pass
                elif modulename == "student_management_app.views" or modulename == "django.views.static":
                    pass
                else:
                ...
                if modulename == "student_management_app.DepartmentHeadViews":
                    pass
                elif modulename == "student_management_app.views" or modulename == "django.views.static":
                    pass
                else:
